// Configuration - use external config if available
const CONFIG = window.IPWHOIS_CONFIG || {
    apiKey: '', // Optional API key from environment or config
...
function initializeApp() {
    ...
    const urlIp = urlParams.get('ip') || urlParams.get('host') || urlParams.get('q');
